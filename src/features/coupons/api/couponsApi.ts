...
export type Coupon={id:number;title:string;code:string;description:string;businessName:string;category:string;discountText:string;targetUserType:string;targetPlanCode:string;imageUrl?:string|null;terms?:string|null;status:string;startDate:string;endDate:string};
